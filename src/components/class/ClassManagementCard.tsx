...
import type { ClassManagementStrings } from '../../i18n/types.app';

interface ClassManagementCardProps {
  activeClass: ClassGroup;
  currentUser: User;
  leavingClassId: string | null;
  strings: ClassManagementStrings;
    ...
    <div className="rounded-2xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
      <div className="border-b border-zinc-200 px-5 py-4 dark:border-zinc-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-black">{strings.title}</h3>
        </div>
            ...
            <div className="flex items-center justify-between gap-4 px-5 py-4">
              <div className="min-w-0">
                <p className="text-sm font-bold">
                  {strings.classCodeTitle}
                </p>
                <p className="mt-1 text-xs text-zinc-500">
                  {strings.classCodeSubtitle}
                </p>
              </div>
