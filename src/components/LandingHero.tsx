  ...
  return (
    <div className="text-center space-y-6 max-w-2xl mx-auto">
      ...
      <p className="text-sm sm:text-base text-zinc-600 font-sans max-w-xl mx-auto leading-relaxed">
        Thesdel is a smart, real-time timetable organizer built
        specifically for university classes. Spot room shifts, track
        cancellations, and safeguard your attendance streaks instantly.
      </p>
