...
import { calculateAttendanceStats, SIMULATED_TODAY, getWeekDates } from '../mockData';
...
export default function AttendanceView({
  ...
  // Let user browse weeks. We have 3 weeks:
  // - Week of 2026-06-29 (start date)
  // - Week of 2026-07-06 (mid week)
  // - Week of 2026-07-13 (current week)
  ...
  return (
    <div className="space-y-8" id="attendance-view-container">
      ...
      {/* Simple Weekly History Table (No charts, just table/grid) */}
      <div className="space-y-4" id="weekly-history-section">
        ...
        {joinedClasses.length === 0 ? (
          ...
          <div className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 divide-y divide-zinc-200 dark:divide-zinc-800" id="weekly-logs-table">
            {visibleDays.map((day) => {
              // Find scheduled entries for this day in joined classes
                    ...
                    <div className="md:col-span-3 space-y-3">
                      {dayEntries.length === 0 ? (
                        ...
                        dayEntries.map((entry) => {
                          // Check if class is past or cancelled
                          let isPast = false;
                          if (day.date < SIMULATED_TOD) {
                            isPast = true;
                          } else if (day.date === SIMULATED_TODAY) {
...
const SIMULATED_TOD = '2026-07-13';
